...
class DateValidatorCommandTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testOnCommand() {
        ...
        $command = new DateValidatorCommand();
		$validString1 = '2014-12-18';
		$validString2 = '2014/12/18';
		$validString3 = '12/18/2014';
		$invalidString1 = '<script>@$delete something</script>';
		$invalidString2 = '2@00.22233';
		$invalidString3 = '200.344';
		//apparently this is invalid
		$invalidString4 = '12-18-2014';
		...
		$result = $command->onCommand('validateDate', $object); 
		...
		$command->onCommand('validateDate', $object); 		
		$this->assertFalse($object->getIsValid());
		...
		//now let's pass in a valid date
